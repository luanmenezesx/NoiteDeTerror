...
string[] mesMonstro = {"O Zumbi", "O Assassino", "O Psicopata", "O Alienígena", "O Carniceiro", "O Matador",
 "O Vampiro", "O Maluco", "O Vingador", "O Monstro", "O Bruxo", "O Demônio" };
string[] diaMonstro = {"Endiabrado", "Radioativo", "Endemoniado", "Vermelho", "Possuído", "Macabro", "Sombrio", "Sem Cabeça",
...
while (true)
{
    ...
    {
        string nomeCompleto = $"{mesMonstro[mes - 1]} {diaMonstro[dia - 1]}";
